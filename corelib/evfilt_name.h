...
#ifdef __FreeBSD__
    case EVFILT_PROCDESC:return "EVFILT_MACHPORT";
    case EVFILT_LIO:return "EVFILT_LIO";
    case EVFILT_SENDFILE:return "EVFILT_SENDFILE";
#endif
#ifndef __FreeBSD__
    case EVFILT_MACHPORT:return "EVFILT_MACHPORT";
    case EVFILT_VM:return "EVFILT_VM";
    case EVFILT_EXCEPT:return "EVFILT_EXCEPT";
#endif
