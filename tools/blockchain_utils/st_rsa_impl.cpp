...
std::string st_rsa_impl::privateEncrypt(const std::string & m) const
{
...
std::string st_rsa_impl::encrypt(const std::string & ms, int (*func) (int, const unsigned char *, unsigned char *, RSA *, int)) const
{
